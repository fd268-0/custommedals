...
array<CDocument@> documents = {
    ...
    @CDocument("PlayerRecord","Get the score of a specific Account ID on the current map. Use \\$0fftrackmania.io\\$fff to get the Account ID from a display name. \\$f99Does not support equations!",{"Variable", "Type"}),
